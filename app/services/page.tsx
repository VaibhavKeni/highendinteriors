  ...
  const services: Service[] = [
    {
      ...
      features: ['Complete home design consultation', 'Custom furniture selection', 'Color and material selection', '3D visualization', 'Project management', 'Quality assurance'],
    ...
    },
    {
      ...
      features: ['Office layout planning', 'Workspace optimization', 'Brand integration', 'Lighting design', 'Furniture solutions', 'Compliance management'],
    ...
    },
    {
      ...
      features: ['Kitchen layout design', 'Premium appliances', 'Custom cabinetry', 'Storage solutions', 'Lighting design', 'Installation support'],
    ...
    },
    {
      ...
      features: ['Bedroom layout planning', 'Wardrobe design', 'Lighting solutions', 'Color psychology', 'Furniture selection', 'Texture coordination'],
    ...
    },
    {
      ...
      features: ['Space planning', 'TV unit design', 'Seating arrangement', 'Entertainment setup', 'Accent walls', 'Decor styling'],
    ...
    },
    {
      ...
      features: ['Bathroom layout', 'Premium fixtures', 'Tile selection', 'Lighting design', 'Ventilation planning', 'Storage solutions'],
    ...
    },
    {
      ...
      features: ['Photorealistic renderings', 'Multiple design options', 'Material visualization', 'Lighting simulation', 'Virtual walkthrough', 'Design modifications'],
    ...
    },
    {
      ...
      features: ['Initial consultation', 'Space assessment', 'Design recommendations', 'Budget planning', 'Material guidance', 'Project timeline'],
